...
WebUI.callTestCase(findTestCase('ReusabilityPractice/Login'), [('username') : username, ('password') : 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM'], 
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Sample Automation')
