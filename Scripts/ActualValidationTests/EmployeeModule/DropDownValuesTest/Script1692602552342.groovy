...
List ddValues = DriverFactory.getWebDriver().findElements(By.xpath('//div[@class="rc-virtual-list"]//div[@class="rc-virtual-list-holder-inner"]/div'))
...
Assert.assertEquals(titles,expectedDepartments)
